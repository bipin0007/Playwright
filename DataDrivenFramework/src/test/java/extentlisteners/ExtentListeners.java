...
public class ExtentListeners implements ITestListener, ISuiteListener {
	...
	public void onTestStart(ITestResult result) {
		...
		//upload photo test - Login Page, User Reg page
	...
	public void onTestFailure(ITestResult result) {
		...
		getExtent().fail("<b><font color=red>" + "Screenshot of failure" + "</font></b><br>",MediaEntityBuilder.createScreenCaptureFromPath(ExtentManager.fileName)
				.build());
